...
public class Lexer {
    ...
    public LinkedList<Token> lex() throws Exception {
        ...
        while (!h.isDone()) {
            ...
            // If we don't regognise the character, throw an exception.
                ...
                throw new Exception(
                        "There is an unexpected \'" + c + "\' at Line: " + lineNumber + " Position: " + position);
            }
        }
        return tokenList;
    }
    ...
    private Token processStringLiterals() throws Exception {
        ...
        while (!h.isDone() && (c != '\"')) {
            ...
            // If we reach the end of the line or the end of the file without a closing '"'
        ...
        // Need to swallow the quotation mark so it doesn't make an incorrect string
        // literal.
        if (!h.isDone())
            h.swallow(1);
        position++;
     ...
     */
    private void initalizeHashMaps(HashMap<String, Token.Type> keyWords, HashMap<String, Token.Type> doubleSymbol,
            HashMap<String, Token.Type> singleSymbol) {
