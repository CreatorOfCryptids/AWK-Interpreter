...
public class TokenHandler {
    ...
    /**
     * Removes and returns the first item in the list if it has the same Token.Type
     ...
     */
    public Optional<Token> matchAndRemove(Token.Type type) {
    ...
    /**
     * Returns a string with the current index and line number to allow for easier
     * debuging for future users of this compiler :)
     * 
    ...
    /**
     * Moved acceptSeperators() to TH for easier testing outside of Parser. Ignore
     * otherwize.
     ...
     *         while (moreTokens() &&
     *         matchAndRemove(Token.Type.SEPERATOR).isPresent())
