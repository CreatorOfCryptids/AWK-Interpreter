...
public class OperationNode extends Node {
    public enum Operation {
        DOLLAR, PREINC, PREDEC, UNARYPOS, UNARYNEG, NOT, /*
                                                          * <- before left node,
                                                          * after left node ->
                                                          */EQ, NE, LT, LE, GT, GE, AND, OR, MATCH, NOTMATCH, POSTINC,
        POSTDEC, IN,
    ...
    private static String[] opToString = new String[] { "$", "++", "--", "+", "-", "!", "==", "!=", "<", "<=", ">",
            ">=", "&&", "||",
            "~", "!~", "++", "--", "in", "^", "+", "-", "*", "/", "%", " cat " };
    // This is just me being extra, basically it stores how the enum would look
    // printed to make a prettier toString().
    ...
    public String toString() {
        // We put parenthesis around the OperationNode to clearly show the order of
        // operations.
        String retval = "(";
